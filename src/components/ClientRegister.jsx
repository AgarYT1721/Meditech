...
import { User, Lock, Activity, Calendar, Phone, Mail, ArrowLeft, Eye, EyeOff } from 'lucide-react';
import { motion } from 'framer-motion';
import Logo from './Logo';

const ClientRegister = ({ onRegisterSubmit, onBackToLogin }) => {
    ...
    <div className="mobile-auth-wrapper" style={{
      ...
      >
        ...
        <motion.div variants={itemVariants}>
          ...
          style={{ background: 'transparent', border: 'none', color: '#888', display: 'flex', alignItems: 'center', gap: '5px', cursor: 'pointer', marginBottom: '20px', fontSize: '0.9rem', padding: 0 }}
        >
        ...
        <motion.div variants={itemVariants} style={{ marginTop: '25px', textAlign: 'center', fontSize: '0.9rem', color: '#666' }}>
          Already have an account? <span onClick={onBackToLogin} style={{ color: '#0066ff', fontWeight: 600, cursor: 'pointer' }}>Sign In</span>
        </motion.div>
        </motion.div>
      </motion.div>
    </div>
